		...
		<Layout name={'BRAND'}>
			<div className='about'>
				...
				<p>
					...
					consectetur odio optio modi expedita, voluptatem nobis vero maxime cumque,
					nesciunt tempora voluptatum tempore facilis dolorum dolores adipisci, itaque
					dicta? Quis recusandae esse dignissimos consequatur sunt error cum eveniet
					corrupti! Rem earum minus odit asperiores commodi reiciendis maiores accusantium
					animi recusandae. Amet illum blanditiis debitis magnam. Saepe quibusdam optio
					quia?
